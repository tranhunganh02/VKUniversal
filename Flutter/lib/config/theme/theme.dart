...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      error: Color(4287646525),
      onError: Color(4294967295),
      errorContainer: Color(4294957779),
      onErrorContainer: Color(4281993731),
      ...
      onSecondaryFixedVariant: Color(4280567671),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      error: Color(4285411364),
      onError: Color(4294967295),
      errorContainer: Color(4289355857),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondary: Color(4294967295),
      secondaryContainer: Color(4280304498),
      onSecondaryContainer: Color(4294967295),
      tertiary: Color(4279574846),
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4281811552),
      onTertiaryContainer: Color(4294967295),
      error: Color(4282585351),
      onError: Color(4294967295),
      errorContainer: Color(4285411364),
      onErrorContainer: Color(4294967295),
      background: Color(4294310651),
      onBackground: Color(4279704862),
      surface: Color(4294310651),
      ...
      onPrimaryFixedVariant: Color(4294967295),
      secondaryFixed: Color(4280304498),
      onSecondaryFixed: Color(4294967295),
      secondaryFixedDim: Color(4278201434),
      onSecondaryFixedVariant: Color(4294967295),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      secondaryContainer: Color(4280567671),
      ...
      error: Color(4294948005),
      onError: Color(4283834131),
      errorContainer: Color(4285740071),
      onErrorContainer: Color(4294957779),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      error: Color(4294949548),
      onError: Color(4281533697),
      errorContainer: Color(4291591275),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      errorContainer: Color(4294949548),
      onErrorContainer: Color(4278190080),
      background: Color(4279112725),
      onBackground: Color(4292797413),
      surface: Color(4279112725),
